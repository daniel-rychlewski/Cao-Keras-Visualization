...
class SaliencyMask(object):
    ...
    def __init__(self, model, layer_number, output_index=0, n_bands=100):
...
class GradientSaliency(SaliencyMask):
    ...
    def __init__(self, model, output_index=0,n_bands=100):
        ...
        self.layer_number = output_index
        self.n_bands = n_bands
    ...
    def get_mask(self, input_image):
        ...
        else:#elif self.layer_number == 1 or self.layer_number == 2:
